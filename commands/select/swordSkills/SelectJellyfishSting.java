...
import hydra.hunter.core.implementations.commands.SelectJellyFishStingImplementations;
...
public class SelectJellyfishSting implements
        SelectJellyFishStingImplementations {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (isHydra(PLAYER_UUID)) {
                ...
                if (hasSwordSkillIgnoreJellyfishSting(PLAYER_UUID)) {
                ...
                hydrasWithJellyfishSting.add(PLAYER_UUID);
