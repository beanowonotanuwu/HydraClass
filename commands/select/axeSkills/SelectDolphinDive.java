...
import hydra.hunter.core.implementations.commands.SelectDolphinDiveImplementations;
...
public class SelectDolphinDive implements
        SelectDolphinDiveImplementations {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (isHydra(PLAYER_UUID)) {
                ...
                if (hasAxeSkillIgnoreDolphinDive(PLAYER_UUID)) {
                ...
                if (hasDolphinDive(PLAYER_UUID)) {
                    ...
                    hydrasWithDolphinDive.remove(PLAYER_UUID);
                ...
                hydrasWithDolphinDive.add(PLAYER_UUID);
