...
import hydra.hunter.core.implementations.commands.SelectAmplifiedClawsImplementations;
...
public class SelectAmplifiedClaws implements
        SelectAmplifiedClawsImplementations {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (isHydra(PLAYER_UUID)) {
                ...
                if (hasPassiveBSkillIgnoreAmplifiedClaws(PLAYER_UUID)) {
                ...
                if (hasAmplifiedClaws(PLAYER_UUID)) {
                    ...
                    hydrasWithAmplifiedClaws.remove(PLAYER_UUID);
                ...
                hydrasWithAmplifiedClaws.add(PLAYER_UUID);
            }
            else {
