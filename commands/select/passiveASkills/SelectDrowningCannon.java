...
import hydra.hunter.core.implementations.commands.SelectDrowningCannonImplementations;
...
public class SelectDrowningCannon implements
        SelectDrowningCannonImplementations {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (isHydra(PLAYER_UUID)) {
                ...
                if (hasPassiveASkillIgnoreDrowningCannon(PLAYER_UUID)) {
                ...
                if (hasDrowningCannon(PLAYER_UUID)) {
                    ...
                    hydrasWithDrowningCannon.remove(PLAYER_UUID);
                ...
                hydrasWithDrowningCannon.add(PLAYER_UUID);
