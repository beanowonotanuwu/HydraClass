...
public class SelectFreezingCannon implements
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (isHydra(PLAYER_UUID)) {
                ...
                if (hasPassiveASkillIgnoreFreezingCannon(PLAYER_UUID)) {
                ...
                if (hasFreezingCannon(PLAYER_UUID)) {
                    ...
                    hydrasWithFreezingCannon.remove(PLAYER_UUID);
                ...
                hydrasWithFreezingCannon.add(PLAYER_UUID);
